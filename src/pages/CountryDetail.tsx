...
export default function CountryDetail() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-blue-950 text-gray-900 dark:text-white px-6 py-8">
      <div className="max-w-5xl mx-auto">
        <Link
          to="/"
          className="inline-block mb-8 px-6 py-2 bg-white dark:bg-blue-800 text-gray-800 dark:text-white shadow rounded hover:bg-gray-100 dark:hover:bg-blue-700"
        >
          ← Back
        </Link>
